...
//            ((DataViewHolder) viewHolder).textdescription.setText(datalist1.get(i).getMetadescription());
...
public class RecyclerViewAdapterForCatagoryProduct extends RecyclerView.Adapter<RecyclerViewAdapterForCatagoryProduct.MyViewHolder> {
    ...
    public RecyclerViewAdapterForCatagoryProduct(Context context, ArrayList<CatagoryWiseProductsModel> datalist1, OnNoteListenerCatagory mOnNoteListenerCatagory) {

        this.context = context;
        this.datalist1 = datalist1;
        this.mOnNoteListenerCatagory = mOnNoteListenerCatagory;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view, mOnNoteListenerCatagory);
    }
...
//        Picasso.get().load(datalist1.get(position).getImage()).into(holder.imageView);
        ...
        holder.textView.setText(datalist1.get(position).getProduct_namecat());
        holder.textdescription.setText(datalist1.get(position).getDescriptioncat());
        holder.textPrice.setText(datalist1.get(position).getPricecat());
        //((DataViewHolder) viewHolder).imageView.setImageResource(datalist1.get(i).getImage());
        Picasso.get().load(datalist1.get(position).getImagecat()).into(holder.imageView);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        //newme
        ImageView imageView;
        OnNoteListenerCatagory mOnNoteListenerCatagory;

        public MyViewHolder(@NonNull View itemView, OnNoteListenerCatagory mOnNoteListenerCatagory) {
            super(itemView);
            textView = itemView.findViewById(R.id.product_name_TV);
            imageView = itemView.findViewById(R.id.model_image);
            textdescription = itemView.findViewById(R.id.product_description_TV);
